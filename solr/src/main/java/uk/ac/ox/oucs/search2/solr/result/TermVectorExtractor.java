...
/**
 * Extract {@link org.apache.solr.handler.component.TermVectorComponent} results from a {@link org.apache.solr.client.solrj.response.QueryResponse}
 * <p>
 * Based on <a href="https://issues.apache.org/jira/browse/SOLR-949">SOLR-949</a>, this extractor will get every
 * information provided by  {@link org.apache.solr.handler.component.TermVectorComponent} and put that in a {@link java.util.Map}
 * of documents with the documentId as the key.<br />
 * The document map contain itself a {@link java.util.Map} of fields available in the document, with the field name as the key.<br />
 * The field map contains itself a {@link java.util.Map} of terms used in the field, with the term as the key.<br />
 * The term map associate a term to a {@link TermInfo}.
 * </p>
 * <p/>
 * TODO: Change nested {@link java.util.Map} to a custom data-structure able to contain more information?
 *
 * @author Colin Hebert
 */
